    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceInteractions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuickBooksSettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashTransactionId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5825bc84-9176-4167-9766-dc21abac79a1", null, "Counter", "COUNTER" },
                    { "7cd4b244-5b57-4984-8a7c-a6d53c22772e", null, "Accountant", "ACCOUNTANT" },
                    { "866bd64e-9f49-4e59-9616-4e460f36c0a4", null, "Admin", "ADMIN" }
                });

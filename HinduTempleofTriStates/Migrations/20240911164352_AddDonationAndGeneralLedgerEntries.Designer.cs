...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240911164352_AddDonationAndGeneralLedgerEntries")]
    partial class AddDonationAndGeneralLedgerEntries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9240d0e-6b39-4bdd-b422-ed978e7a9b22"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1bf52093-b593-455f-97af-23c679fca081"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 11, 12, 43, 51, 239, DateTimeKind.Local).AddTicks(2530),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("e7eca47e-55be-4fd0-94ff-8a44036541a1"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e7eca47e-55be-4fd0-94ff-8a44036541a1"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 11, 16, 43, 51, 239, DateTimeKind.Utc).AddTicks(2484),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 11, 16, 43, 51, 239, DateTimeKind.Utc).AddTicks(2485)
                        });
                });

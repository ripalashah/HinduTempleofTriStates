...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912012308_EnableCascadingDeletes")]
    partial class EnableCascadingDeletes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f2e150d7-77d8-4f4a-936d-12d0cb6efad5"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a2b02235-78af-4d3c-9ad4-8c8940bfceb6"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 1, 23, 7, 204, DateTimeKind.Utc).AddTicks(4911),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("b450720d-0cd3-454c-b7a5-de11fc6e425d"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b450720d-0cd3-454c-b7a5-de11fc6e425d"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 1, 23, 7, 204, DateTimeKind.Utc).AddTicks(4863),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 1, 23, 7, 204, DateTimeKind.Utc).AddTicks(4864)
                        });
                });

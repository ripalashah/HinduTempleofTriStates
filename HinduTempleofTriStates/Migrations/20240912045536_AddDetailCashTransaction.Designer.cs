...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912045536_AddDetailCashTransaction")]
    partial class AddDetailCashTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2feae16b-1c72-4e4a-9943-d371c1750880"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("790e858b-33fe-4521-a199-3f8dbc82aa17"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 4, 55, 35, 839, DateTimeKind.Utc).AddTicks(1716),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("70d0d942-936e-4a64-9ad2-22d4ec4feb10"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("70d0d942-936e-4a64-9ad2-22d4ec4feb10"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 4, 55, 35, 839, DateTimeKind.Utc).AddTicks(1672),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 4, 55, 35, 839, DateTimeKind.Utc).AddTicks(1673)
                        });
                });

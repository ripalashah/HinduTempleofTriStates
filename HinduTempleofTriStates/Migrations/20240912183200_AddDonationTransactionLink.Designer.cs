...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912183200_AddDonationTransactionLink")]
    partial class AddDonationTransactionLink
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("62c408a1-52a5-4c02-80f1-246a5b9368bb"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 12, 18, 31, 59, 107, DateTimeKind.Utc).AddTicks(7087),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2531c219-d25b-4600-948c-39156162f6f6"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 18, 31, 59, 107, DateTimeKind.Utc).AddTicks(7118),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("b9ae3ed8-dbde-4747-b307-7993daf9c154"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b9ae3ed8-dbde-4747-b307-7993daf9c154"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 18, 31, 59, 107, DateTimeKind.Utc).AddTicks(7062),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 18, 31, 59, 107, DateTimeKind.Utc).AddTicks(7063)
                        });
                });

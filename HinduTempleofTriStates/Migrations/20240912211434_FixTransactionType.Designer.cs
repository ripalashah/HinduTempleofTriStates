...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912211434_FixTransactionType")]
    partial class FixTransactionType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d0cb50a7-eab3-4dc8-bd12-50385623ba91"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 12, 21, 14, 32, 685, DateTimeKind.Utc).AddTicks(7572),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("10874740-41c4-42e7-afd4-19736a88ec0c"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 21, 14, 32, 685, DateTimeKind.Utc).AddTicks(7610),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("e0b3c676-2f86-4672-bea4-bb76c8fc6db1"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e0b3c676-2f86-4672-bea4-bb76c8fc6db1"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 21, 14, 32, 685, DateTimeKind.Utc).AddTicks(7548),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 21, 14, 32, 685, DateTimeKind.Utc).AddTicks(7548)
                        });
                });

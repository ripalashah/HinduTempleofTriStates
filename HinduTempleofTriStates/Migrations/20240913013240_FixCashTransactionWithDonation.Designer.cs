...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240913013240_FixCashTransactionWithDonation")]
    partial class FixCashTransactionWithDonation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bb5be6b1-efb6-4e96-91cc-840eb94dcd4d"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 13, 1, 32, 38, 818, DateTimeKind.Utc).AddTicks(6096),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c30c4e1d-595f-4601-a2af-40c3ca6c3223"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 13, 1, 32, 38, 818, DateTimeKind.Utc).AddTicks(6122),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("7a085f3c-7c25-4404-8486-737d6c3581e3"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7a085f3c-7c25-4404-8486-737d6c3581e3"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 13, 1, 32, 38, 818, DateTimeKind.Utc).AddTicks(6073),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 13, 1, 32, 38, 818, DateTimeKind.Utc).AddTicks(6074)
                        });
                });

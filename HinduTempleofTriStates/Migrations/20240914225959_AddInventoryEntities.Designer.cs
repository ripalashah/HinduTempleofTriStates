...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240914225959_AddInventoryEntities")]
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("672b7100-76c3-4e05-b9d5-c88ca6c76d0b"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 14, 22, 59, 57, 278, DateTimeKind.Utc).AddTicks(6858),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("146ec742-465c-4a22-a0d3-caef695d5ed4"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 14, 22, 59, 57, 278, DateTimeKind.Utc).AddTicks(6953),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("a1fcf56c-84fe-4a0d-a4ca-7dc92958ed01"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1fcf56c-84fe-4a0d-a4ca-7dc92958ed01"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 14, 22, 59, 57, 278, DateTimeKind.Utc).AddTicks(6814),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 14, 22, 59, 57, 278, DateTimeKind.Utc).AddTicks(6815)
                        });
                });

...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912000518_AddDonationRelationships")]
    partial class AddDonationRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8523d208-4832-4944-9977-cb8b09d1cda4"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a92038cb-0d11-496d-ab92-5db938801b29"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 0, 5, 17, 526, DateTimeKind.Utc).AddTicks(4358),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("1a6b817b-328b-4df4-a531-f2a204958958"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1a6b817b-328b-4df4-a531-f2a204958958"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 0, 5, 17, 526, DateTimeKind.Utc).AddTicks(4298),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 0, 5, 17, 526, DateTimeKind.Utc).AddTicks(4299)
                        });
                });

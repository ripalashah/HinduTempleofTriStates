...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912044011_UpdateCashTransaction")]
    partial class UpdateCashTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("45f82b40-150f-4e53-9325-86f0fd54e52d"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d4886adc-fd5b-4d5f-80d4-81e2b4eb8d0c"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 4, 40, 10, 17, DateTimeKind.Utc).AddTicks(673),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("a456fffc-93b9-4124-91bc-ecf6ed75a4b2"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a456fffc-93b9-4124-91bc-ecf6ed75a4b2"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 4, 40, 10, 17, DateTimeKind.Utc).AddTicks(625),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 4, 40, 10, 17, DateTimeKind.Utc).AddTicks(625)
                        });
                });

...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912011100_GeneralLedgerEntries")]
    partial class GeneralLedgerEntries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("07fab9f9-55b7-4733-b0d1-8000757bac68"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0d3ed7e1-a289-47b3-bf0e-e51d537e8760"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 1, 11, 0, 33, DateTimeKind.Utc).AddTicks(2625),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("e8587b0d-ea8b-48e4-b5ef-679cf80bcbc2"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e8587b0d-ea8b-48e4-b5ef-679cf80bcbc2"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 1, 11, 0, 33, DateTimeKind.Utc).AddTicks(2575),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 1, 11, 0, 33, DateTimeKind.Utc).AddTicks(2576)
                        });
                });

...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240914042005_FixDonationCashTransactionForeignKey")]
    partial class FixDonationCashTransactionForeignKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a7918a94-9cc2-40b9-952b-e15eb25cda70"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 14, 4, 20, 4, 642, DateTimeKind.Utc).AddTicks(1922),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b00750b7-efdf-493f-968d-ddc056c4e5d6"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 14, 4, 20, 4, 642, DateTimeKind.Utc).AddTicks(1987),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            Email = "hindutempleoftristtate@gmail.com",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("f28db259-2734-459a-af30-07e2fac47a57"),
                            Phone = "123-456-7890",
                            ReceiptNumber = "D0001",
                            State = "Anystate"
                        });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f28db259-2734-459a-af30-07e2fac47a57"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 14, 4, 20, 4, 642, DateTimeKind.Utc).AddTicks(1896),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 14, 4, 20, 4, 642, DateTimeKind.Utc).AddTicks(1897)
                        });
                });

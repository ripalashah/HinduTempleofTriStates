...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240923153439_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d52e7867-b121-4bfa-afd2-3711b396b91e"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 23, 15, 34, 39, 68, DateTimeKind.Utc).AddTicks(8923),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.DeviceInteraction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("82266338-f8f9-4061-b38a-3f090259c109"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 23, 15, 34, 39, 68, DateTimeKind.Utc).AddTicks(8948),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            IsSynced = false,
                            LedgerAccountId = new Guid("82a965ac-bdb2-4ced-8484-2db559f7be51"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("82a965ac-bdb2-4ced-8484-2db559f7be51"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 23, 15, 34, 39, 68, DateTimeKind.Utc).AddTicks(8899),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 23, 15, 34, 39, 68, DateTimeKind.Utc).AddTicks(8900)
                        });
                });

            modelBuilder.Entity("HinduTempleofTriStates.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.StockTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OAuthToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuickBooksSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("253d28e2-bf2f-491f-a16c-75804eeef56e"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Product", b =>
                {
                    b.HasOne("HinduTempleofTriStates.Models.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.StockTransaction", b =>
                {
                    b.HasOne("HinduTempleofTriStates.Models.Product", "Product")
                        .WithMany()

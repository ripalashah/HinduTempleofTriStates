...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240914141235_UpdateDonationMode2")]
    partial class UpdateDonationMode2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("87b99f49-1d3b-42fd-83eb-828bb7d534ec"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 14, 14, 12, 33, 937, DateTimeKind.Utc).AddTicks(1922),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f9609824-7fad-4775-a1f4-2045d3c143c1"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 14, 14, 12, 33, 937, DateTimeKind.Utc).AddTicks(2026),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("fb437932-bab1-4ac9-86cb-dfa8e58cfcc5"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fb437932-bab1-4ac9-86cb-dfa8e58cfcc5"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 14, 14, 12, 33, 937, DateTimeKind.Utc).AddTicks(1885),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 14, 14, 12, 33, 937, DateTimeKind.Utc).AddTicks(1886)
                        });
                });

...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240914041614_FixForeignKeyForDonationAndCashTransaction")]
    partial class FixForeignKeyForDonationAndCashTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1ab2f2f5-ad71-41bf-a4e4-064cb6e16b90"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 14, 4, 16, 14, 500, DateTimeKind.Utc).AddTicks(4683),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9ef18f23-8da0-44f7-85ad-cff231691bd6"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 14, 4, 16, 14, 500, DateTimeKind.Utc).AddTicks(4722),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            Email = "hindutempleoftristtate@gmail.com",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("499b5621-a346-401b-b8e7-620b5e6c601e"),
                            Phone = "123-456-7890",
                            ReceiptNumber = "D0001",
                            State = "Anystate"
                        });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("499b5621-a346-401b-b8e7-620b5e6c601e"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 14, 4, 16, 14, 500, DateTimeKind.Utc).AddTicks(4657),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 14, 4, 16, 14, 500, DateTimeKind.Utc).AddTicks(4658)
                        });
                });

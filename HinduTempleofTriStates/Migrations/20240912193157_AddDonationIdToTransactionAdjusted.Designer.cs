...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912193157_AddDonationIdToTransactionAdjusted")]
    partial class AddDonationIdToTransactionAdjusted
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e3ba79f8-22b4-4991-bb3b-f924def81343"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 12, 19, 31, 57, 60, DateTimeKind.Utc).AddTicks(9902),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("097bd80a-3944-4992-abff-9f53c4b6f4bd"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 19, 31, 57, 60, DateTimeKind.Utc).AddTicks(9929),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("13816c9c-088a-4b2c-a531-1c4bb43a1f28"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.GeneralLedgerEntry", b =>
                {
                    ...
                    b.Property<Guid?>("GeneralLedgerEntryId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("13816c9c-088a-4b2c-a531-1c4bb43a1f28"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 19, 31, 57, 60, DateTimeKind.Utc).AddTicks(9877),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 19, 31, 57, 60, DateTimeKind.Utc).AddTicks(9878)
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.GeneralLedgerEntry", b =>
                {
                    ...
                    b.HasOne("HinduTempleofTriStates.Models.GeneralLedgerEntry", null)
                        .WithMany("GeneralLedgerEntries")

...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912001559_RemoveCascadeForGeneralLedgerEntries")]
    partial class RemoveCascadeForGeneralLedgerEntries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("69ec8f3c-1be6-4d5a-9cc2-7272a5be3ba8"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b4a69a07-f7dc-4a8d-ad87-247b567c7174"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 0, 15, 57, 771, DateTimeKind.Utc).AddTicks(6039),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("e41e38a9-a91b-4c69-88fd-6ec40530789a"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e41e38a9-a91b-4c69-88fd-6ec40530789a"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 0, 15, 57, 771, DateTimeKind.Utc).AddTicks(5995),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 0, 15, 57, 771, DateTimeKind.Utc).AddTicks(5996)
                        });
                });

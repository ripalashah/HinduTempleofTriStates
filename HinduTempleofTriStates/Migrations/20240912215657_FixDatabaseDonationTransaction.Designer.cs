...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912215657_FixDatabaseDonationTransaction")]
    partial class FixDatabaseDonationTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fe163c3b-d7be-4b47-af89-7d94e198a415"),
                            AccountName = "Default Account",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedDate = new DateTime(2024, 9, 12, 21, 56, 56, 60, DateTimeKind.Utc).AddTicks(4316),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c40833aa-1f1a-4114-ac20-5fdfed52e6a9"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 21, 56, 56, 60, DateTimeKind.Utc).AddTicks(4341),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("3e0b04f4-1933-4f8d-9c49-5620eabbd5f0"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3e0b04f4-1933-4f8d-9c49-5620eabbd5f0"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 21, 56, 56, 60, DateTimeKind.Utc).AddTicks(4294),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 21, 56, 56, 60, DateTimeKind.Utc).AddTicks(4294)
                        });
                });

...
namespace HinduTempleofTriStates.Migrations
{
    ...
    [Migration("20240912001118_RemoveCascadeOnGeneralLedgerEntries")]
    partial class RemoveCascadeOnGeneralLedgerEntries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8a8c6378-3df3-44b3-877c-06db82d3dd16"),
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("13b043fe-5d03-41e0-8037-5c20346e15d8"),
                            Amount = 100.0,
                            City = "Anytown",
                            Country = "Anycountry",
                            Date = new DateTime(2024, 9, 12, 0, 11, 18, 442, DateTimeKind.Utc).AddTicks(5467),
                            DonationCategory = "General",
                            DonationType = "One-Time",
                            DonorName = "John Doe",
                            IsDeleted = false,
                            LedgerAccountId = new Guid("2226eb7c-4198-424d-89e3-107385d165f0"),
                            Phone = "123-456-7890",
                            State = "Anystate"
                        });
                });
            ...
            modelBuilder.Entity("HinduTempleofTriStates.Models.LedgerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2226eb7c-4198-424d-89e3-107385d165f0"),
                            AccountId = new Guid("00000000-0000-0000-0000-000000000000"),
                            AccountName = "Default Ledger",
                            AccountType = 5,
                            Balance = 0m,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 9, 12, 0, 11, 18, 442, DateTimeKind.Utc).AddTicks(5421),
                            IsDeleted = false,
                            UpdatedBy = "System",
                            UpdatedDate = new DateTime(2024, 9, 12, 0, 11, 18, 442, DateTimeKind.Utc).AddTicks(5422)
                        });
                });
